...
export default function ImovelAdd() {
    ...
    const handleSubmit = async () => {
        ...
        formData.append("cidade", city.trim())
        formData.append("bairro", neighborhood.trim())
        formData.append("endereco", adress.trim())
        ...
        formData.append("linkInstagram", instagramLink.trim())
